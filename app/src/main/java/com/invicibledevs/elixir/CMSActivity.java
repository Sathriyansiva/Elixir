...
public class CMSActivity extends AppCompatActivity implements Runnable {
    ...
    private int paidByValue, amountTypeValue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amountTypeValue = getIntent().getIntExtra("amountTypeValue",0);
    ...
    public void run()
    {
        if(isInternetConnected())
        {
            ...
            if(isOTPRequest)
                ...
                apiHelper.sendCMS(theCMS, aUser, getApplicationContext(), handler);
        }
        else
        {
