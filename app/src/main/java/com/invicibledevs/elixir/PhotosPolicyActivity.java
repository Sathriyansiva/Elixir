    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (resultCode == RESULT_OK) if (requestCode == REQUEST_CAMERA) {
            ...
            try {
                ...
                thumbnail = Elixir.imageOreintationValidator(thumbnail, fi.getAbsolutePath());
...
//                Glide.with(this).load("https://an-awesome-image.com").into(Button);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("PhotosPolicy Page") // TODO: Define a title for the content shown.
